...
<script>
import KInput from './Form_element_ui/Input.vue';
import KFormItem from './Form_element_ui/FormItem.vue';
import KForm from './Form_element_ui/Form.vue';
export default {
  name: "app",
  components: {
    KInput,
  ...
  data() {
    return {
      value:'tc-form',
      model: { username: "XuTianCheng", password: "" },
      rules: {
        username: [
