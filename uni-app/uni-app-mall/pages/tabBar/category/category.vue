	...
	<view>
		...
		<view class="category-list">
			...
			<scroll-view  scroll-y="true" class="left" >
		        <view class="row" v-for="(category,index) in categoryList" :key="category.id" :class="{'on': index==showCategoryIndex}" @tap="showCategory(index)">
					<view class="text">
...
<script>
	import pageHead from '../home/pageHeader.vue'
